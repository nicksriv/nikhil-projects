...
class OthersController: UIViewController, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    // @IBOutlet var collectView: UIColl    ectionView!
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "othersMovie") {
        ...
        if(segue.identifier == "othersView") {
