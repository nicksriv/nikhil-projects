...
class othersCollectionView: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=all&category=others&limit=1000&offset=0", completion: didLoadShots)
    ...
    func loadList1(notification: NSNotification){
        //load data here
        print("loadlis1")
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=action&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList2(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=adventure&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList3(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=animation&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList4(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=comedy&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList5(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=crime&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList6(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=drama&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList7(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=family&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList8(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=fantasy&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList9(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=horror&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList10(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=mystery&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList11(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=romance&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList12(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=sci-fi&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList13(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=uncategorized&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList14(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=religious&category=others&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "othersDetail") {
