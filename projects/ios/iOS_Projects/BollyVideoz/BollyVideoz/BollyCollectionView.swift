...
//  TransferCategory
//
//  Created by Dignitas Digital on 7/25/15.
//  Copyright (c) 2015 Dignitas Digital. All rights reserved.
//

import UIKit

class bollyCollectionView: UIViewController, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=all&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
    ...
    func loadList1(notification: NSNotification){
        //load data here
        print("loadlis1")
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=action&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList2(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=adventure&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList3(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=animation&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList4(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=comedy&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList5(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=crime&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList6(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=drama&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList7(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=family&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList8(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=fantasy&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList9(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=horror&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList10(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=mystery&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList11(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=romance&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList12(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=sci-fi&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList13(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=uncategorized&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    func loadList14(notification: NSNotification){
        //load data here
        api.loadShots("http://158.85.122.170:81/mongo_api/grid_call.php?genres=religious&category=bollywood&limit=1000&offset=0", completion: didLoadShots)
        //  self.collectionViewOutlet.reloadData()
    }
    ...
    {
    return CGSizeMake((UIScreen.mainScreen().bounds.width)/4,157); //use height whatever you wants.
    }
    */
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "bollyDetail") {
