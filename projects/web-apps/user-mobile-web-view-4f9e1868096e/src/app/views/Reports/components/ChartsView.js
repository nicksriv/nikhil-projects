...
import { setChartFilter } from 'app/redux/ReportsManagement/reportsManagementSlice';
import EmptyView from 'app/components/EmptyView/EmptyView';
import { cloneDeep } from 'lodash';
import { V5GlobalIconButtons } from 'app/components'
import Multiselect1 from 'app/components/Multiselect/Multiselect1';
...
function ChartsView() {
    ...
    const { sitesForCharts, charts, chartFilter } = useSelector((state) => state.reports)
