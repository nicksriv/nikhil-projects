...
import { setModuleFilterDetails } from 'app/redux/ModuleManagement/moduleManagementSlice';
...
function DrawerFilterPopup(props) {
    ...
    const [columnsAndFiltersCopy, setColumnsAndFiltersCopy] = useState(columnsAndFilters);
    ...
    useEffect(() => {
        setColumnsAndFiltersCopy({ ...columnsAndFilters });
