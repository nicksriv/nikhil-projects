...
import { setModuleFilterDetails, setStateByName, setFiltersData, clearFilter } from 'app/redux/ModuleManagement/moduleManagementSlice';
...
function FilterChips({ chipInfo, filtersInfo, primaryColor }) {
    ...
    const { empRole } = useSelector((state) => state.modules);
