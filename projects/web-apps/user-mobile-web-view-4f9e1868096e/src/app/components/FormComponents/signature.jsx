import { Button, IconButton, Grid, Modal, Typography, FormLabel } from '@mui/material';
...
const V5Signature = (props) => {
    ...
    const save = () => {
        ...
        var base64ImageContent = sigData.replace(/^data:image\/(png|jpg);base64,/, "");
            ...
            <ThemeProvider theme={theme}>
                ...
                { !dataGet ?
                    <Grid className={classes.container}>
                        {formik.values[data.id] ? <img src={`${ONBOARDING_API_ENDPOINT}${ONBOARDING_APIVERSION}/files/${formik.values[data.id]}`} height="78" /> : <Grid className={classes.child} onClick={handleOpen}>
                        ...
                        >
                            <Box className={classes.modalStyle}>
                                <Grid className={classes.modalHeading}>
                                    <Typography variant='h5' style={{fontFamily:fontFamily}}>{data.label}</Typography>
                                ...
                                <Grid item className={classes.button}>
                                    <Button size="medium" variant="outlined" style={{width:'160px', color:primaryColor,fontFamily:fontFamily, border:`1px solid ${primaryColor}`}} onClick={clear} >
                                        Clear
                                    </Button>
                                    <Button size="medium" style={{backgroundColor:primaryColor,fontFamily:fontFamily }} variant="contained" className={classes.saveButton} onClick={save} >
                                        Save
                                    </Button>
                                </Grid>
                            </Box>
                    ...
                    <Grid className={classes.containerOne}>
                        ...
                        <img src={signature} width="80" height="78" style={{ backgroundColor: "white"}}/>
                    </Grid>
                }
            </ThemeProvider>
        </Grid>
