...
import V5FormBuilderPreviewPopup from './v5-form-builder-preview-popup';
...
export default class V5FormBuilderDemoBar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    saveFeatureTemplate(e) {
        e.preventDefault();
        let jsonData = this.state.data.map(({ globalStyles, ...remainingAttrs }) => remainingAttrs);
    ...
    render() {
        ...
        const tooltipText = `Status changes to Draft if user clicks on "SAVE SCREEN" button but didn't publish the module.`;
        return (
            <>
                <div className="react-form-builder clearfix" style={{
                    bottom: 0, display: "flex", zIndex: 600,
                    position: "sticky", alignItems: "center", marginBottom: "-1rem",
                    marginTop: "0.2rem", width: "100%"
                }}>
                    <div className="react-form-builder-preview" style={{ minHeight: '0px', marginTop: '4px', padding: "15px 10px" }}>
                        {
                        ...
                        <Button
                            variant="outlined"
                            className={`${this.state.data.length > 0 ? 'color-primary border-primary' : '#00000061'}`}
                            style={{
                                maxWidth: '91px',
                                maxHeight: '35px',
                                minWidth: '91px',
                        ...
                        <Button
                            ...
                            onClick={(e) => this.saveFeatureTemplate(e)}
                            disabled={this.state.data.length > 0 ? false : true}
                        >
                            SAVE FEATURE TEMPLATE
                        </Button>
                        {
                            this.props.showMasterScreen ?
                                (
                                    <>
                                        <Button
                                            variant="contained"
                                            ...
                                            onClick={(e) => this.publishScreen(e)}
                                        >
                                            {'PUBLISH'}
                                        </Button>
                                    </>
                                ...
                                (
                                    <>
                                        {
                                            this.state.data.length > 0 && this.props.screenName ?
                                                (
                                                    <Button
                                                        variant="contained"
                                                        className="float-right bg-primary"
                ...
                <div className="clearfix" style={{ margin: '10px', width: '70%' }}>
                    {/* {
                        ...
                        <div className="react-form-builder clearfix">
                            <div className="react-form-builder-preview float-left">
                                <button className="btn btn-primary float-right" style={{ marginRight: '10px' }} onClick={(e) => this.showPreview(e)}>PREVIEW</button>
                            </div>
                        </div>
                    }
