...
var DragDropElements = /*#__PURE__*/_react["default"].forwardRef(function (_ref, ref) {
  var greedy = _ref.greedy,
      ...
      items = _ref.items,
      col = _ref.col,
      getDataByArrayId = _ref.getDataByArrayId,
      rest = (0, _objectWithoutProperties2["default"])(_ref, ["greedy", "isOver", "isOverCurrent", "connectDropTarget", "items", "col", "getDataByArrayId"]);
  var item = items[col];
  ...
  }, arrayElements.map(function (ele) {
    return /*#__PURE__*/_react["default"].createElement("div", null, ele);
  })));
});
