    ...
    value: function create(item) {
      ...
      if (!this.props.isBootstrapElements) {
        ...
        if (item.key === 'Long_Text') {
          ...
          elementOptions.customOptions.validationOptions = 'None,Alphabetic,AlphaNumeric'; // elementOptions.customOptions.min = 0;
          // elementOptions.customOptions.max = 1;
        }
      ...
      if (item.key === 'Configurable_List') {
        ...
        elementOptions.customOptions.editRow = false; // elementOptions.headerList = [{
        //   label: 'Header Item 1',
        //   headerId: "0",
        //   required: false,
        //   type: 'text',
