...
var ConfigurableOptions = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2["default"])(ConfigurableOptions, _React$Component);
  ...
  function ConfigurableOptions(props) {
    ...
    (0, _classCallCheck2["default"])(this, ConfigurableOptions);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "maximalRows", function (e) {
      var this_element = _this.state.element;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "minimalRows", function (e) {
      var this_element = _this.state.element;
      var value = e.target.value;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "addLabelChange", function (e) {
      var this_element = _this.state.element;
      var value = e.target.value;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "removeLabelChange", function (e) {
      var this_element = _this.state.element;
      var value = e.target.value;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "tableRowActions", function (elemProp) {
      var this_element = _this.state.element;

      if (!this_element.customOptions[elemProp]) {
        this_element.customOptions[elemProp] = true;
      } else {
        this_element.customOptions[elemProp] = false; // this_element.customOptions.headerList.map((h, i) => {
  ...
  (0, _createClass2["default"])(ConfigurableOptions, [{
    key: "_defaultItems",
    ...
    value: function removeTableHeader(el) {
      var count = (0, _toConsumableArray2["default"])(this.state.count); // make a separate copy of the array
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_core.Grid, {
        ...
        }, "Mandatory Field: "), /*#__PURE__*/_react["default"].createElement(_core.FormControlLabel // this_required={this_required}
        , {
          name: "is_required",
          style: {
            position: "relative",
          ...
          control: /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_core.Button, {
            ...
            ,
            name: "Yes" // color={this_required ? "primary" : "default"}

          }, (0, _defineProperty2["default"])(_React$createElement, "name", "is_required"), (0, _defineProperty2["default"])(_React$createElement, "onClick", function onClick(e) {
