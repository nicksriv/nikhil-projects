...
function V5FormBuilderPreviewPopup(props) {
  ...
  var style = (_style = {
    ...
    boxShadow: 24
  }, _defineProperty(_style, "border", 'none !important'), _defineProperty(_style, "borderRadius", '4px'), _defineProperty(_style, "width", "".concat(currentSelectedView === deviceViewsEnum.MOBILE ? '360px' : currentSelectedView === deviceViewsEnum.TABLET ? '768px' : '992px')), _style);
  ...
  }, /*#__PURE__*/_react.default.createElement(_DesktopMac.default
  //onClick={(e) => handleDeviceView(e, deviceViewsEnum.DESKTOP)}
  , {
    className: "cursor-pointer",
    style: {
      marginRight: '10px',
      color: "".concat(currentSelectedView === deviceViewsEnum.DESKTOP ? '#2C3E93' : '#bbb')
    }
  }), /*#__PURE__*/_react.default.createElement(_TabletMac.default
  //onClick={(e) => handleDeviceView(e, deviceViewsEnum.TABLET)}
  , {
    className: "cursor-pointer",
    style: {
      marginRight: '10px',
      color: "".concat(currentSelectedView === deviceViewsEnum.TABLET ? '#2C3E93' : '#bbb')
    }
    ...
    style: {
      marginRight: '10px',
      color: "".concat(currentSelectedView === deviceViewsEnum.MOBILE ? '#2C3E93' : '#bbb')
    }
  })), /*#__PURE__*/_react.default.createElement(_core.Grid, {
    item: true,
    className: "mr-2"
