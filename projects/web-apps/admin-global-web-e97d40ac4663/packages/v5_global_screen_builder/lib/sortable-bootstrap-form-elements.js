...
var Name = _formElements.default.Name,
  Phone = _formElements.default.Phone,
  Header = _formElements.default.Header,
...
var FormElements = {};
FormElements.Name = (0, _sortableElement.default)(Name);
...
FormElements.Mapping_Dropdown = (0, _sortableElement.default)(Dropdown);
