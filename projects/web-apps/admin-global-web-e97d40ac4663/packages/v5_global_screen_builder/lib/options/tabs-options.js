...
var TabsOptions = /*#__PURE__*/function (_React$Component) {
  _inherits(TabsOptions, _React$Component);
  var _super = _createSuper(TabsOptions);
  function TabsOptions(props) {
    var _this;
    _classCallCheck(this, TabsOptions);
    _this = _super.call(this, props);
    _defineProperty(_assertThisInitialized(_this), "tabsTextAreaHandleChange", function (e) {
