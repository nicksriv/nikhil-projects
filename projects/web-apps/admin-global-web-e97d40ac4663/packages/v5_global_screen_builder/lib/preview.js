...
var Preview = /*#__PURE__*/function (_React$Component) {
  ...
  function Preview(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateGlobalStyleOptions", function (propType, value) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateFormDefault", function (element) {
    ...
    _this.getDataByArrayId = _this.getDataByArrayId.bind(_assertThisInitialized(_this));
    _this.setArrayAsChild = _this.setArrayAsChild.bind(_assertThisInitialized(_this));
    _this.removeChildFromArray = _this.removeChildFromArray.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(Preview, [{
    ...
    value: function removeChildFromArray(item, itemList, col) {
      var data = this.state.data;
      var oldItems = itemList.childItems[col];
      // eslint-disable-next-line no-param-reassign
