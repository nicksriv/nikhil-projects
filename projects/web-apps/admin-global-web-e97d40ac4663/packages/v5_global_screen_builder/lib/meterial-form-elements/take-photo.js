...
var TakePhoto = /*#__PURE__*/function (_React$Component) {
  _inherits(TakePhoto, _React$Component);
  var _super = _createSuper(TakePhoto);
  function TakePhoto(props) {
    var _this;
    _classCallCheck(this, TakePhoto);
    _this = _super.call(this, props);
    _defineProperty(_assertThisInitialized(_this), "setImageSrc", /*#__PURE__*/function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "saveAdditionalOptions", function (property, e) {
      if (property == 'feet') {
    ...
    _defineProperty(_assertThisInitialized(_this), "onClickImagePreview", function (index) {
