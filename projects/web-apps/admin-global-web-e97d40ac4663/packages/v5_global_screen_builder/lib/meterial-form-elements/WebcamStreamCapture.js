...
var WebcamStreamCapture = /*#__PURE__*/function (_React$Component) {
  _inherits(WebcamStreamCapture, _React$Component);
  var _super = _createSuper(WebcamStreamCapture);
  function WebcamStreamCapture(props) {
    var _this;
    _classCallCheck(this, WebcamStreamCapture);
    _this = _super.call(this, props);
    _defineProperty(_assertThisInitialized(_this), "handleVideoUpload", function (clickSource, e) {
  ...
  _createClass(WebcamStreamCapture, [{
    ...
    key: "deleteVideo",
    value: function () {
      var _deleteVideo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var _this3 = this;
        var stream;
