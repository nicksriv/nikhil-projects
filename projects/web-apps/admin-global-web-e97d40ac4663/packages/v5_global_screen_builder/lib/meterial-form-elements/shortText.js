...
var Short_Text = /*#__PURE__*/function (_React$Component) {
  _inherits(Short_Text, _React$Component);
  var _super = _createSuper(Short_Text);
  function Short_Text(props) {
    var _this;
    _classCallCheck(this, Short_Text);
    _this = _super.call(this, props);
    _defineProperty(_assertThisInitialized(_this), "onBlurEvent", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangeEvent", function (e) {
      console.log(e.target.value, e.target.value.length, _this.props.data.customOptions.charLimit);
