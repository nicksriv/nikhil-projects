...
var TakeVideo = /*#__PURE__*/function (_React$Component) {
  _inherits(TakeVideo, _React$Component);
  var _super = _createSuper(TakeVideo);
  function TakeVideo(props) {
    var _this;
    _classCallCheck(this, TakeVideo);
    _this = _super.call(this, props);
    _defineProperty(_assertThisInitialized(_this), "setVideoSrc", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(clickSource, imageFileObj, imageType) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 7:
                newVideos = {
                  ...
                  azimuthAngle: _this.state.azimuthAngle
                  // meter: meter,
    ...
    _defineProperty(_assertThisInitialized(_this), "handleCommentsChange", function (e) {
      var status = {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleVideoUpload", function () {
      var data = _this.props.videoUploadCallback("Sample video url");
    });
    _defineProperty(_assertThisInitialized(_this), "onClickVideoPreview", function (index) {
