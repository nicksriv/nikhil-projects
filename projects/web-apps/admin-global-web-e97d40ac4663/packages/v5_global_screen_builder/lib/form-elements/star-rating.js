...
var StarRating = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(StarRating, [{
    ...
    value: function render() {
      ...
      }, _defineProperty(_cx, "react-star-rating__size--".concat(this.props.size), this.props.size), _defineProperty(_cx, 'rating-editing', this.state.editing), _cx));
      ...
      return /*#__PURE__*/_react.default.createElement("span", {
        ...
        className: classes
      }, starRating, /*#__PURE__*/_react.default.createElement("input", _defineProperty({
        type: "number",
        name: this.props.name,
