...
var FormElementsEdit = /*#__PURE__*/function (_React$Component) {
  ...
  function FormElementsEdit(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleAttachments", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDeleteVideo", function () {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDeleteFile", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMaxSize", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleHyperlink", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeFieldVarient", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeInputFieldSize", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeButtonType", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeTextAlginment", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "updateFormDefault", function (value) {
      _this.props.updateFormDefault(_this.state.element);
    });
    _defineProperty(_assertThisInitialized(_this), "textAreaHandleChange", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this), "showTextEmptyOption", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "setInputMaskedValue", function (e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeCameraOptions", function (elementProperty, e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "setPhotoCustomOptions", function (elementProperty, e) {
      var this_element = _this.state.element;
    ...
    _defineProperty(_assertThisInitialized(_this), "setCutomeTime", function (timeValue, elemProp, e) {
      var this_element = _this.state.element;
    ...
    _this.setNumberLimit = _this.setNumberLimit.bind(_assertThisInitialized(_this));
    _this.editElementProp = _this.editElementProp.bind(_assertThisInitialized(_this));
    _this.setValidationType = _this.setValidationType.bind(_assertThisInitialized(_this));
    _this.setValidationOptions = _this.setValidationOptions.bind(_assertThisInitialized(_this));
    _this.setInputMaskedValue = _this.setInputMaskedValue.bind(_assertThisInitialized(_this));
    _this.setDefaultOptions = _this.setDefaultOptions.bind(_assertThisInitialized(_this));
    _this.setDisplayOptions = _this.setDisplayOptions.bind(_assertThisInitialized(_this));
    _this.setActionClick = _this.setActionClick.bind(_assertThisInitialized(_this));
    _this.setScreenSelect = _this.setScreenSelect.bind(_assertThisInitialized(_this));
    _this.handleTilesOptions = _this.handleTilesOptions.bind(_assertThisInitialized(_this));
    _this.handleTableOptions = _this.handleTableOptions.bind(_assertThisInitialized(_this));
    _this.addTilesOptions = _this.addTilesOptions.bind(_assertThisInitialized(_this));
    _this.addTableOptions = _this.addTableOptions.bind(_assertThisInitialized(_this));
    _this.removeTilesOptions = _this.removeTilesOptions.bind(_assertThisInitialized(_this));
    _this.removeTableOptions = _this.removeTableOptions.bind(_assertThisInitialized(_this));
    ...
    _this.handleAttachments = _this.handleAttachments.bind(_assertThisInitialized(_this));
    _this.handleHyperlink = _this.handleHyperlink.bind(_assertThisInitialized(_this));
    _this.handleSelectedIcon = _this.handleSelectedIcon.bind(_assertThisInitialized(_this));
    _this.handleDropdownDataOptions = _this.handleDropdownDataOptions.bind(_assertThisInitialized(_this));
    _this.handledropDownOptions = _this.handledropDownOptions.bind(_assertThisInitialized(_this));
    _this.handleMaxSize = _this.handleMaxSize.bind(_assertThisInitialized(_this));
    _this.handleFile = _this.handleFile.bind(_assertThisInitialized(_this));
    _this.handleDeleteFile = _this.handleDeleteFile.bind(_assertThisInitialized(_this));
    _this.handleVideoChange = _this.handleVideoChange.bind(_assertThisInitialized(_this));
    _this.handleDeleteVideo = _this.handleDeleteVideo.bind(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(FormElementsEdit, [{
    ...
    key: "handleFile",
    value: function () {
      var _handleFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    value: function () {
      var _handleVideoChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var files, this_element;
    ...
    value: function handleTilesOptions(elemProperty, index, e) {
      ...
      if (elemProperty == "spacing") {
        ...
        //..Component Source
        var cs = this_element.customOptions.tileProperties[index].componentOnScreenSource;
        //..Component Target
    ...
    value: function render() {
      ...
      var sectionHeaderBGColor = this.props.element.customOptions.sectionHeaderBGColor;
      ...
      var dropdown_options = this.props.element.customOptions.hasOwnProperty('dropDownOptions') ? this.props.element.customOptions.dropDownOptions : [];
      ...
      var toolbarProps = {
        items: ['Short_Text', 'Long_Text', 'Button', 'Number', 'Dropdown', 'Mapping_Dropdown', 'Email', 'Date_Picker', 'Time']
      };
      ...
      elementKey == "Attachment" && /*#__PURE__*/_react.default.createElement(_core.Grid, {
        ...
        return /*#__PURE__*/_react.default.createElement(_core.Grid, {
          ...
          control: /*#__PURE__*/_react.default.createElement(_core.Checkbox, {
            onChange: _this8.handleAttachments
      ...
      elementKey == "Phone" && /*#__PURE__*/_react.default.createElement(_core.Grid, {
        item: true,
        xs: 12
      }, /*#__PURE__*/_react.default.createElement(_phoneOptions.default
      // this_mask={this_mask} 
      , {
        c_code: c_code,
        editElementCustomOptionsProp: this.editElementCustomOptionsProp.bind(this)
      ...
      this.props.element.hasOwnProperty('singleChoiceOptions') && this.props.element.singleChoiceOptions.length > 0 && elementKey === "Single_Choice" && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_singleChoiceOptions.default, {
        ...
        item: true,
        xs: 12
      }, /*#__PURE__*/_react.default.createElement(_configurableListOptions.default, _extends({
        showCorrectColumn: this.props.showCorrectColumn,
        canHaveOptionCorrect: canHaveOptionCorrect,
        canHaveOptionValue: canHaveOptionValue,
        data: this.props.preview.state.data,
      ...
      }, "Pick a color for Section Header Background")),
      // INPUT TABLE OPTIONS
      isMaterialTable && /*#__PURE__*/_react.default.createElement(_core.Grid, {
        ...
        label: "Site",
        value: "SITE"
      }].map(), this_files.map(function (file) {
      ...
      })) : null), this.props.element.element == "Mapping_Dropdown" && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, /*#__PURE__*/_react.default.createElement("li", null, "It will get list dynamically from site mapped to User."), /*#__PURE__*/_react.default.createElement("li", null, "For mapping site against User, go to \"User Management\" page and upload site data."))))), this.props.element.element == "Dropdown" && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
        className: "form-group pb-4",
        style: {
          borderBottom: "1px solid #bebebe"
        }
      ...
      elementKey != "Section_Header" && elementKey != "Page_Break" && elementKey != "Input_Table" && elementKey != "Button" && elementKey != "Attachment" && elementKey !== "Tiles" && elementKey != "Photo" && elementKey != "Configurable_List" && elementKey != "Location_Coordinates" && elementKey != 'Video' && elementKey != "Barcode_Scanner" && elementKey != "Signature" && elementKey != "Button" && /*#__PURE__*/_react.default.createElement(_core.Grid, {
        ...
        || charLimit > 120 || charLimit < 0 ? true : this.props.element.customOptions.charLimit == "" && this.props.element.element == "Short_Text" && (this.props.element.customOptions.validation === 'Alphabetic' || this.props.element.customOptions.validation === 'AlphaNumeric' || this.props.element.customOptions.validation === 'Numeric') ? true : this.props.element.customOptions.isVideoLink && this.state.videoLinkDisable ? true : this.props.element.customOptions.isVideoLink && this.props.element.customOptions.videoLink === "" ? true : this.props.element.customOptions.defaultTime === "custom" && this.state.selectedTime === null ? true : elementKey === "Photo" && this.state.element.customOptions.maxSize > 5 || this.state.element.customOptions.maxSize < 1 ? true : elementKey === "video" && this.state.element.customOptions.maxSize > 10 || this.state.element.customOptions.maxSize < 1 ? true :
