...
var items = ['Photo', 'Short_Text', 'Email', 'Number', 'Phone', 'Single_Choice', 'Dropdown', 'Mapping_Dropdown', 'Check_List', 'Date_Picker', 'Header', 'Long_Text', 'Signature', 'Section_Header', 'Location_Coordinates', 'Tab_Break', 'Configurable_List', 'Button_Radios', 'Input_Table', 'Photo_PREPOST', 'Page_Break', 'Two_Column_Row', 'Three_Column_Row', 'Four_Column_Row', 'Attachment'];
var toolboxOrigin = "right"; // left | right
var V5FormBuilder = /*#__PURE__*/function (_React$Component) {
  _inherits(V5FormBuilder, _React$Component);
  var _super = _createSuper(V5FormBuilder);
  function V5FormBuilder(props) {
    _classCallCheck(this, V5FormBuilder);
    return _super.call(this, props);
  }
  _createClass(V5FormBuilder, [{
    key: "render",
