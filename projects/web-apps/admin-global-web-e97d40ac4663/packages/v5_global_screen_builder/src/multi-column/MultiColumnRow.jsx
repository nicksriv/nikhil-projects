...
const Two_Column_Row = ({ data, class_name, ...rest }) => {
...
const Three_Column_Row = ({ data, class_name, ...rest }) => {
...
const Four_Column_Row = ({ data, class_name, ...rest }) => {
...
export { Two_Column_Row, Three_Column_Row, Four_Column_Row };
