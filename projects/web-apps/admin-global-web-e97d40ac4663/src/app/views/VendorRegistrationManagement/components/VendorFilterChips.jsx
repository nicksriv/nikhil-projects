...
function VendorFilterChips({ chipInfo }) {
    ...
    const handleDelete = (value) => {
        ...
        dispatch({ type: setVendorRegistrationDetailFilter.type, payload: data })
        setChipData(data)
    }
    ...
    const handleClear = () => {
        let vendorRegistrationFilterDetails = {
            vendorName: '',
            mobile: '',
            email: '',
        }
        ...
        dispatch({
            ...
            payload: vendorRegistrationFilterDetails,
        })
    }
    return (
