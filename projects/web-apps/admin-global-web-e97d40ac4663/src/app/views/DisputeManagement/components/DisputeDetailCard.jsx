        ...
        return (
            <Grid container spacing={1}>
                {data.map((b, i) => {
                    return (
                        <>
                            <Grid item xs={12} sm={(b.label === 'Dispute Description:' || b.label === 'Closed Remark:') ? 12 : 6} lg={(b.label === 'Dispute Description:' || b.label === 'Closed Remark:') ? 12 : 6}>
                                <div
                                    style={{
                                        display: 'flex',
                                        flexFlow: 'row',
