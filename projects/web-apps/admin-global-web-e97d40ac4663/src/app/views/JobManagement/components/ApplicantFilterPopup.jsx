...
import { setApplicantFilterDetails } from 'app/redux/JobManagement/JobManagementSlice'
...
function ApplicantFilterPopup({ chipInfo, close }) {
    const classes = useStyles()
    const { applicantFilterDetails } = useSelector(
        (state) => state.jobManagement
    )
    const validationSchema = Yup.object({})

    const formik = useFormik({
        initialValues: applicantFilterDetails,
...
const Form = ({ formik, close }) => {
    const {
        values: { userType, jobApplicationStatus, from, to },
        errors,
        touched,
        handleChange,
        isValid,
    ...
    const jobApplicationStatusDropdownOptions = [
        {
            id: 0,
            name: 'NEW',
        },
                ...
                <Grid container justify="space-between" className="mb-10 mt-5">
                    ...
                    <Grid item>
                        ...
                        >
                            ...
                            {jobApplicationStatusDropdownOptions &&
                                jobApplicationStatusDropdownOptions.map(
                                    (jobApplicationStatus) => (
                                        <MenuItem
                                            name="jobApplicationStatus"
                                            key={jobApplicationStatus.id}
                                            value={jobApplicationStatus.name}
                                        >
