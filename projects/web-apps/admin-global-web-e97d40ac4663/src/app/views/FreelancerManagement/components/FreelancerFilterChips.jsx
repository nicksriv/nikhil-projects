...
} from 'app/redux/FreelancerManagement/FreelancerManagementSlice'
...
function FreelancerFilterChips({ chipInfo }) {
    ...
    const handleDelete = (value) => {
        ...
        dispatch({ type: setFreelancerFilterDetails.type, payload: data })
        setChipData(data)
    }
...
export default FreelancerFilterChips
