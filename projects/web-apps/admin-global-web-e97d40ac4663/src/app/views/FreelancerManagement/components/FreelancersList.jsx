...
export default function FreelancersList({
    ...
    const handleView = (selectedFreelancerId) => {
        if (selectedFreelancerId && selectedFreelancerId.id) {
            const id = selectedFreelancerId.id
            history.push(`/freelancer/freelancerDetails/${id}`)
        }
    }

    const handleInfo = (selectedFreelancerId) => {
        if (selectedFreelancerId && selectedFreelancerId.id) {
            const id = selectedFreelancerId.id
            history.push(`/freelancer/freelancerDetails/${id}`)
        }
