...
dateTimeHelper.displayDate = (date) => date ? dateTimeHelper.format(date, "$Do $MMM $YYYY") : "";
...
dateTimeHelper.jobDateTime = (date) => date ? dateTimeHelper.format(date, "$Do $MMM, $YYYY $hh:$mm $A") : "";
