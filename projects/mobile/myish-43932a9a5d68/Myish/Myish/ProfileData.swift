...
class ProfileData{
    ...
    var followers: Array<NSDictionary>!
    var following: Array<NSDictionary>!
    var postsData: [Posts]!
    ...
    init(data : NSDictionary){
        ...
        self.followers = data["followers"] as! Array<NSDictionary>
        
        self.following = data["following"] as! Array<NSDictionary>
...
//        }
       ...
       // self.postsData.reverse() // to show posts in reverse chronological order.
        
                self.postscount = data["postscreatedcount"] as! Int
        
                self.followingcount = data["followingcount"] as! Int
        
                self.followerscount = data["followerscount"] as! Int
