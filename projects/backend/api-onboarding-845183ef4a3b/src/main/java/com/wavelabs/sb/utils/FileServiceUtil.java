...
//                .withCannedAcl(CannedAccessControlList.AuthenticatedRead.PublicRead));
    ...
    public String uploadFile(MultipartFile multipartFile, String path, String fileName) throws Exception {
    ...
    public String uploadFreelancerProfileImage(MultipartFile multipartFile, String freelancerRefNo) throws Exception {
    ...
    public String uploadFreelancerResume(MultipartFile multipartFile, String freelancerRefNo) throws Exception {
        String[] fileText = multipartFile.getOriginalFilename().split("\\.");
        String extension = fileText[fileText.length - 1];
        String fileName = freelancerRefNo + "." + extension;
    ...
    public String uploadVendorPortfolio(MultipartFile multipartFile, String vendorRefNo) throws Exception {
        String[] fileText = multipartFile.getOriginalFilename().split("\\.");
        String extension = fileText[fileText.length - 1];
    ...
    public String uploadVendorCompanyLogo(MultipartFile multipartFile, String vendorRefNo) throws Exception {
        String[] fileText = multipartFile.getOriginalFilename().split("\\.");
        String extension = fileText[fileText.length - 1];
        String fileName = vendorRefNo + "." + extension;
    ...
    public String uploadVendorUserProfileImage(MultipartFile multipartFile, String userRef, String vendorUserId) throws Exception {
        String[] fileText = multipartFile.getOriginalFilename().split("\\.");
        String extension = fileText[fileText.length - 1];
