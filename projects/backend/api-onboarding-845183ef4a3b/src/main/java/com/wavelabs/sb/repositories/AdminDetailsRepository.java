...
public interface AdminDetailsRepository extends MongoRepository<AdminDetails, String> {
    ...
    Optional<AdminDetails> findByAdminIdAndStatusAndDeleted(String adminId, Status active, boolean deleted);

    List<AdminDetails> findByDeleted(boolean deleted);

    List<AdminDetails> findByDeletedAndIdNot(boolean b, String id);
