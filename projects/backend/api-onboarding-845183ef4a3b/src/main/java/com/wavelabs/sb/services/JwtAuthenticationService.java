...
public class JwtAuthenticationService {
    ...
    public String generateToken(String adminId, String clientId, String userId, String typeOfUser, String id,
	    String clientSystemId, String firstName, String lastName, String userRole) {

	logger.info("Inside Generate token method..");
	String token = Jwts.builder().setSubject(clientId)
		.setClaims(getClaims(adminId, clientId, userId, typeOfUser, id, clientSystemId, firstName, lastName,
			userRole))
    ...
    private Map<String, Object> getClaims(String adminId, String clientId, String userId, String typeOfUser, String id,
	    String clientSystemId, String firstName, String lastName, String userRole) {
	...
	claims.put("id", id);
	claims.put("clientSystemId", clientSystemId);
	...
	try {
	    tokenPayLoadDetails = mapper.readValue(body, TokenPayLoadDetails.class);
            ...
            if (tokenPayLoadDetails.getTypeOfUser().equalsIgnoreCase(Constants.FREELANCER)
